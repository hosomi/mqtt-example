...
public class MqttPublisher {
	...
	public static void main(String[] args) {
		...
		String content = args[0]; // Publishするメッセージ内容
		try {
			MqttClient mqttClient = new MqttClient(brokerTcp, clientId, new MemoryPersistence());
			...
			L.info("Connecting to broker: {}", brokerTcp);
